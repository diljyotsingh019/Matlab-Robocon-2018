...
% Last Modified by GUIDE v2.5 23-Feb-2018 20:39:08
...
global a;
sr1 = get(hObject,'Value');
writePWMVoltage(a,'D8',sr1);
set(handles.edit2,'string',num2str(sr1));
guidata(hObject,handles);
...
global a;
sr2 = get(hObject,'Value');
writePWMVoltage(a,'D9',sr2);
set(handles.edit3,'string',num2str(sr2));
guidata(hObject,handles);
...
b= get(hObject,'Value');
d=b*0.85;
x=readPosition(servo1);
writePosition(servo1,d);
...
c= get(hObject,'Value');
e=c*0.85;
y=readPosition(servo2);
writePosition(servo2,e);
...
% handles    structure with handles and user data (see GUIDATA)
set(handles.edit1,'string',eventdata);
...
global a;
sr3 = get(hObject,'Value');
writePWMVoltage(a,'D8',sr3);
writePWMVoltage(a,'D9',sr3);
set(handles.edit6,'string',num2str(sr3));
guidata(hObject,handles);
